...
- `components/TimeBar.tsx`: combined timeline UI (ruler + time bar), seek cursor, drag range selection, and seek-source reporting.
...
- Selected comments and draft timeline ranges can loop between their start and end times; see `docs/video-player-page/loop-selected-range.md`.
