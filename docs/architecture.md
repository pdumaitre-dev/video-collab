...
- `components/TimeBar.tsx`: combined timeline UI (ruler + time bar), seek cursor, drag range selection, comment ranges, and chapter markers.
...
- `Chapter_blob`: named point-in-time chapters keyed by Blob pathname.
