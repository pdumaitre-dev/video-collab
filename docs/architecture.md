...
- `app/videos/[videoId]/VideoPageShell.tsx` loops the active draft range or saved-comment range when the comments-panel **Loop range** toggle is enabled. See `docs/video-player-page/loop-selected-range.md`.
