...
- Threaded replies: show one top-level card per timeline marker; reveal replies through an expand/hide control and indent nested replies with a subtle left border.
