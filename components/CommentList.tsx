...
export default function CommentList({
  ...
  if (comments.length === 0) {
    return (
      <div className="mt-4 rounded-lg border border-dashed border-divider-emphasis bg-surface-card/50 py-8 text-center">
          ...
          <li
            ...
            className={`group cursor-pointer rounded-lg border px-3 py-3 text-sm transition-all ${
              isSelected
                ...
                : "border-divider bg-surface-card hover:border-divider-emphasis hover:bg-surface-elevated"
            }`}
